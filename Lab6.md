...
### Results for 4 five letter pairs:
![fiveletters](Images/fiveorderresults.PNG)
...
### Results for 2 four letter pairs:

![fourletters](Images/fourorderresults.PNG)
...
if __name__ == '__main__':
    ...
    print("Two words are connected if they differ in one letter, ignoring order.")
    print("Graph has %d nodes with %d edges"
          % (nx.number_of_nodes(G), nx.number_of_edges(G)))
    print("%d connected components" % nx.number_connected_components(G))
...
![unordered](Images/fiveunorderresults.PNG)